...
# /data/web/static and /data/web/media
...
SECRET_KEY = os.getenv('SECRET_KEY', 'your-default')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Context processor personalizados
                'store.context_processors.cart_context_processor',
            ],
        },
    },
]
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        'OPTIONS': {'min_length': 8}, # mínimo de 8 crst para a senha
    },
    {
    ...
    {
        'NAME': 'utils.validator.password.ComplexityValidator'
    }
]
